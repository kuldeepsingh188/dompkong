              ...
              {Products.map((data) => {
                  return (
                      <div data-aos="flip-left" data-aos-duration="1000" className='sm:w-1/2 md:w-1/3 px-3 pt-5 '>
                          <div className='border-[1px] rounded-[16px] hover:text-black border-solid border-white hover:bg-[#FDDA60] transition-all ease-linear relative overflow-hidden'>
                              ...
                              <p className='text-white text-[24px]  font-semibold font-Montserrat pt-[16px] text-center'>{data.heading}</p>
